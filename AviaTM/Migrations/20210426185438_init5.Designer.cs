...
namespace AviaTM.Migrations
{
    ...
    [Migration("20210426185438_init5")]
    partial class init5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportTransportLoadCapacity", b =>
                {
                    b.Property<int>("TransportLoadCapacitysId")
                        .HasColumnType("integer");

                    b.Property<int>("TransportsId")
                        .HasColumnType("integer");

                    b.HasKey("TransportLoadCapacitysId", "TransportsId");

                    b.HasIndex("TransportsId");

                    b.ToTable("TransportTransportLoadCapacity");
                });
            ...
            modelBuilder.Entity("TransportTransportLoadCapacity", b =>
                {
                    b.HasOne("AviaTM.DB.Model.Models.TransportLoadCapacity", null)
                        .WithMany()
                        .HasForeignKey("TransportLoadCapacitysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AviaTM.DB.Model.Models.Transport", null)
                        .WithMany()
