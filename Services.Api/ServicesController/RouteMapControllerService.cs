...
{
    public class RouteMapControllerService : IRouteMapControllerService
    {
        private readonly ApplicationDbContext _context;
        private readonly UserContext _userContext;

        public RouteMapControllerService(ApplicationDbContext context, UserContext userContext)
        {
            _context = context;
